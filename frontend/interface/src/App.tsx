...
function App() {
  ...
  return (
    <>
    <div className="App">
      <Card name="Habitica web" imageLink={img_hab_web} testsAvailable={testHabiticaWeb.length} tests={testHabiticaWeb} setLoading={setLoading} setResults={setResults}  />
      <Card name="Habitica movil" imageLink={img_hab_movil} testsAvailable={testHabiticaMovil.length} tests={testHabiticaMovil} setLoading = {setLoading} setResults={setResults} />
